package com.solar.stepdefinations;

import org.openqa.selenium.By;
import org.openqa.selenium.JavascriptExecutor;

import com.solar.helper.WaitHelper;
import com.solar.pageobjects.LoginLogoutPage;
import com.solar.testbase.TestBase;
import com.solar.utils.GlobalProperties;
...
public class loginLogoutPageStepDefinitions extends TestBase {
	...
	public void i_enter_username_as(String arg1) throws Throwable {
		System.out.println(GlobalProperties.getPropertyMap().get("username"));
		loginPage.enterUserName(GlobalProperties.getPropertyMap().get("username"));
	}
